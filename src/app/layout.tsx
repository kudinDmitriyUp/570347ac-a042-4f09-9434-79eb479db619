...
export const metadata: Metadata = {
  title: "Grand Boutique Hotel - Luxury Redefined",
  description: "Experience unparalleled elegance at Grand Boutique Hotel. Luxury accommodations, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, boutique hotel, premium accommodation, spa, fine dining, concierge service",
  metadataBase: new URL("https://grandboutiquehotel.com"),
  alternates: {
    canonical: "https://grandboutiquehotel.com"
  },
  openGraph: {
    title: "Grand Boutique Hotel - Luxury Redefined",
    description: "Experience unparalleled elegance at Grand Boutique Hotel with luxury accommodations and exceptional service.",
    siteName: "Grand Boutique",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763547270315-ueluvoos.jpg",
        alt: "Grand Boutique Hotel exterior"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Grand Boutique Hotel - Luxury Redefined",
    description: "Experience unparalleled elegance at Grand Boutique Hotel with luxury accommodations and exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763547270315-ueluvoos.jpg"]
  },
  robots: {
    index: true,
    follow: true
